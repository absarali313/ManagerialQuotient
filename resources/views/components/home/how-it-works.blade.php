    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                <x-ui.step-item number="01" title="Add Employees" description="" color="blue">
                    <x-slot:icon>
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path></svg>
                    </x-slot:icon>
                </x-ui.step-item>

                <x-ui.step-item number="02" title="Assign Assignment" description="" color="indigo">
                    <x-slot:icon>
                ...
                <x-ui.step-item number="04" title="Track Performance" description="" color="pink">
                    <x-slot:icon>
                ...
                <x-ui.step-item number="05" title="Make Decision" description="" color="green">
                    <x-slot:icon>
